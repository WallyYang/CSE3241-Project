SELECT A.Name
 ...
 WHERE A.AuthorId = W.AuthorId AND W.Isbn = B.Isbn AND C.Email = personal_sum.Email AND personal_sum.Spent > avg(personal_sum.Spent) AND P.Customer = C.Email AND P.Book = B.Isbn
