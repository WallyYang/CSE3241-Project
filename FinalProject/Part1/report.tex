...
\item Sample SQL Queries
  ...
  \item Find the titles of all books by Pratchett that cost less than \$10
    ...
    \begin{align*}
      ...
      &\mathit{R2} \leftarrow \sigma_{\mathit{A.Name} = \textit{Terry Pratchett}}(R1)\\
  ...
  \item Return a table that contains the email and name of the customer who has the most reward point on his or her account
  ...
  \item Provide a list of customer names and e-mail addresses for customers who have spent more than the average customer.
